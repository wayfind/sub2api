...
import type { SubscriptionPlan, Announcement, AnnouncementTargeting } from '@/types'
...
async function loadSubscriptionPlans() {
  try {
    const all = await adminAPI.subscriptionPlans.getAll()
    subscriptionPlans.value = all || []
  } catch (error: any) {
