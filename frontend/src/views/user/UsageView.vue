          ...
          <div class="flex items-center gap-3">
            ...
            <div class="min-w-0 flex-1">
              ...
              <p class="text-xl font-bold text-green-600 dark:text-green-400">
                                {{ (usageStats?.total_actual_cost || 0).toFixed(4) }} U
              </p>
              <p class="text-xs text-gray-500 dark:text-gray-400">
                {{ t('usage.actualCost') }} /
                <span class="line-through">{{ (usageStats?.total_cost || 0).toFixed(4) }} U</span>
          ...
          <template #cell-cost="{ row }">
            <div class="flex items-center gap-1.5 text-sm">
              <span class="font-medium text-green-600 dark:text-green-400">
                {{ formatCostU(row.actual_cost, 6) }} U
              </span>
              <span class="ml-1 text-xs text-gray-400">{{ formatRmbApprox(row.actual_cost) }}</span>
              <!-- Cost Detail Tooltip -->
              <div
                class="group relative"
        ...
        <div class="space-y-1.5">
          ...
          <div class="mb-2 border-b border-gray-700 pb-1.5">
            ...
            <div v-if="tooltipData && tooltipData.input_cost > 0" class="flex items-center justify-between gap-4">
              ...
              <span class="font-medium text-white">{{ tooltipData.input_cost.toFixed(6) }} U</span>
            </div>
            <div v-if="tooltipData && tooltipData.output_cost > 0" class="flex items-center justify-between gap-4">
              <span class="text-gray-400">{{ t('admin.usage.outputCost') }}</span>
              <span class="font-medium text-white">{{ tooltipData.output_cost.toFixed(6) }} U</span>
            </div>
            ...
            <div v-if="tooltipData && tooltipData.cache_creation_cost > 0" class="flex items-center justify-between gap-4">
              ...
              <span class="font-medium text-white">{{ tooltipData.cache_creation_cost.toFixed(6) }} U</span>
            </div>
            <div v-if="tooltipData && tooltipData.cache_read_cost > 0" class="flex items-center justify-between gap-4">
              <span class="text-gray-400">{{ t('admin.usage.cacheReadCost') }}</span>
              <span class="font-medium text-white">{{ tooltipData.cache_read_cost.toFixed(6) }} U</span>
            </div>
          </div>
          <!-- Rate and Summary -->
          ...
          <div class="flex items-center justify-between gap-6">
            ...
            <span class="font-medium text-white">{{ tooltipData?.total_cost.toFixed(6) }} U</span>
          </div>
          <div class="flex items-center justify-between gap-6 border-t border-gray-700 pt-1.5">
            <span class="text-gray-400">{{ t('usage.billed') }}</span>
            <span class="font-semibold text-green-400"
              >{{ tooltipData?.actual_cost.toFixed(6) }} U</span
            >
          </div>
        </div>
        <!-- Tooltip Arrow (left side) -->
...
import { formatDateTime, formatReasoningEffort, formatCostU, formatRmbApprox } from '@/utils/format'
