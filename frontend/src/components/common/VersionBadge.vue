        ...
        >
          ...
          <div class="p-4">
            ...
            <template v-else>
              ...
              <!-- Priority 5: Up to date - no action needed -->
              <div v-else-if="releaseInfo?.html_url && releaseInfo.html_url !== '#'" class="py-2 text-center text-sm text-gray-500 dark:text-dark-400">
                {{ t('version.upToDate') }}
              </div>
            </template>
          </div>
