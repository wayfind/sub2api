...
const userNavItems = computed((): NavItem[] => {
  const items: NavItem[] = [
    ...
    { path: '/payment', label: t('nav.wechatPay'), icon: RechargeSubscriptionIcon, hideInSimpleMode: true },
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/wechat-pay', label: t('nav.wechatPay'), icon: RechargeSubscriptionIcon, hideInSimpleMode: true },
